...
//     secondary: "#73b1deff",
//     onSecondary: "#FFFFFF",
//     secondaryContainer: "#efe9f5",
//     onSecondaryContainer: "#0C2610",
...
const darkTheme = {
  ...
  colors: {
    ...
    primary: "#90CAF9",
    onPrimary: "#0A2342",
    primaryContainer: "#2B3C57",
    onPrimaryContainer: "#D9E9FF",

    secondary: "#73b1deff",
    onSecondary: "#0B1E0D",
    secondaryContainer: "#efe9f5",
    onSecondaryContainer: "#D6F4D8",
            ...
            headerBackground: (props) => {
              return (
                <LinearGradient
                  ...
                  style={[styles.hero]}></LinearGradient>
              );
            },
          }}
